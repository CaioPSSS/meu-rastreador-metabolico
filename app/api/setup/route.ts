                                  ...
                                  goal,
                                      weeklyRate: Number(weeklyRate)
                                          ...
                                          const settings = await prisma.userSettings.upsert({
                                              where: { id: 'singleton' },
                                                  update: { age: Number(age), height: Number(height), gender, activityLevel: Number(activityLevel), goal, weeklyRate: Number(weeklyRate), currentCalorieTarget: initialTarget },
                                                      create: { id: 'singleton', age: Number(age), height: Number(height), gender, activityLevel: Number(activityLevel), goal, weeklyRate: Number(weeklyRate), currentCalorieTarget: initialTarget }
                                                        });

                                                          // Salvar o peso inicial no log de hoje caso não exista histórico
