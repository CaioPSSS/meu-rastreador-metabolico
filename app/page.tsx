...
import { useMetabolicData, Log, LogFormState, SetupFormState } from './hooks/useMetabolicData';
...
export default function Home() {
  const { settings, logs, insights, loading, error, refresh } = useMetabolicData();
